...
#define M6809_RDMEM(Addr)	GetByte(m6809->hardware,Addr)
#define M6809_WRMEM(Addr,Value)	SetByte(m6809->hardware,Addr,Value)
...
#define SET_FLAGS8I(t)          {CC|=m6809->hardware->flags8i[(t)&0xff];}
#define SET_FLAGS8D(t)          {CC|=m6809->hardware->flags8d[(t)&0xff];}
