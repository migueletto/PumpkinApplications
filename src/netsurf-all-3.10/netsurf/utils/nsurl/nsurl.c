...
nserror nsurl_get_utf8(const nsurl *url, char **url_s, size_t *url_l)
{
	...
	*url_s = malloc(*url_l);
	...
	sys_snprintf(*url_s, *url_l, "%s%s%s", scheme, idna_host, path);
