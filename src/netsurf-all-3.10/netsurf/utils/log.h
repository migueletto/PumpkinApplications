...
extern nserror nslog_init(void *ensure, int *pargc, char **argv);
...
extern void nslog_log2(int level, const char *file, const char *func, int ln, const char *format, ...);
...
#define NSLOG(catname, level, logmsg, args...)				\
	do {								\
		nslog_log2(NSLOG_LEVEL_##level, __FILE__, LOG_FN, LOG_LN, logmsg , ##args); \
	} while(0)
