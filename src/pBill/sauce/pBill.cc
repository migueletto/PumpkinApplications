...
static UInt32 ApplyScreenMode() {
    ...
    if (depth < 4 || WinScreenMode(winScreenModeSet, (UInt32 *)NULL, (UInt32 *)NULL, &depth, (Boolean *)NULL) != errNone) {
...
UInt32 PilotMain(UInt16 cmd, void *cmdPBP, UInt16 launchFlags) {
    ...
    FormType *pfrm;
    UInt16 formID;
    UInt32 next_draw_ticks = 0;
    UInt32 tick_rate = 350 * SysTicksPerSecond() / 1000;
    int hiScore = -1;
    UInt32 oldDepth;
    ...
    if (cmd == sysAppLaunchCmdNormalLaunch) {
        ...
        while (1) {
            ...
            if (e.eType == appStopEvent) {
                ...
                FrmCloseAllForms();
                WinScreenMode(winScreenModeSet, (UInt32 *)NULL, (UInt32 *)NULL, &oldDepth, (Boolean *)NULL);
                return 0;
            }
